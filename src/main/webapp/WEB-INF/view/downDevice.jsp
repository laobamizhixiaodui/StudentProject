...
<div class="ok-body">
    <form class="layui-form ok-form" lay-filter="downItem">
        ...
        <fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="buyTime" placeholder="请选择申请日期 格式为yyyy-MM-dd" autocomplete="off"
        ...
        <fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="downDate" placeholder="请选择申请日期 格式为yyyy-MM-dd"  autocomplete="off"
                               class="layui-input" id="downDate" lay-verify="required">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" name="pdoPerson" placeholder="请输入经办人" lay-verify="required"
                               autocomplete="off">
                    </div>
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit lay-filter="down">立即报废</button>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    layui.use(["element", "jquery", "form", "laydate", "okLayer", "okUtils"], function () {
        ...
        laydate.render({elem: "#downDate", type: "date", trigger: 'click'});
